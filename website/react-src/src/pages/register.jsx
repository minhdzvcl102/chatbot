    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            setErrors(prevErrors => ({
                ...
                server: error.response?.data?.message || "Đăng kí  thất bại. Vui lòng thử lại.",
            }));
                ...
                >
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <input
                            ...
                            className={`w-full px-5 py-3 rounded-xl bg-[#eef2f6] text-base text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-400 border-none ${errors.confirmPass ? 'border border-red-500' : ''
                                }`}
                        />
                        {errors.confirmPass && (
                            <span className="text-red-500 text-sm">
